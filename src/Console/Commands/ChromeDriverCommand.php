...
/**
 * Stolen from https://github.com/laravel/dusk/blob/7.x/src/Console/ChromeDriverCommand.php
...
class ChromeDriverCommand extends Command
{
	...
	protected $description = 'Install local ChromeDriver binary for Dawn';
